        ...
        >
                  ...
                  <div className="volume-track">
                    ...
                    <div className="volume-control">
                      <input
                        ...
                        value={karaokeVolume}
                        onChange={(e) =>
                          setKaraokeVolume(parseFloat(e.target.value))
                        }
                        className="volume-slider karaoke"
                      />
                      <span className="volume-value">
                        {Math.round(karaokeVolume * 100)}%
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="volume-track">
                    ...
                    <div className="volume-control">
                      <input
                        ...
                        onChange={(e) =>
                          setRecordingVolume(parseFloat(e.target.value))
                        }
          ...
          <div className="mixing-modal-actions">
            ...
            <button
              ...
              disabled={
                !initialized || isExporting || !!initError || uploadSuccess
              }
